...
#### Topic 1: Blockchain, Token, and Central Bank Digital Currency
  ...
  6. **S, Jin**, Y. Xia, B. Xu. “Scalability Meets Regulation: UTXO-Based Sharding and Zero-Knowledge Proofs for Regulated Digital Currencies”. Under 2nd round review at _Cluster Computing_. (No.3 of Computing Systems journals on [Google Scholar's h5-index](https://scholar.google.com.hk/citations?view_op=top_venues&hl=en&vq=eng_computingsystems).)
...
Most technical work is finished before joinning HKUST, which serves as foundation of my understanding on blockchain, token, etc.
  ...
  1.  **S. Jin**, K. Tam, B. Zeng, Q Shao, Y Huang, Y. Xia, B Zhu, Z Li. “FinQMC - A Quantum Leap in Monte Carlo Methods for Finance”. Reject and resubmit to _INFORMS Journal on Data Science_.
