...
<div class="course-container">
  ...
  <div class="course-details">
    ...
    <p><strong>Student feedback (SFQ, Fall 2023):</strong> 4.27/5 overall satisfaction with teaching; 4.18/5 with the lab sections</p>
  </div>
...
<div class="course-container">
  ...
  <div class="course-details">
    ...
    <p><strong>Student feedback (SFQ, Spring 2023):</strong> 4.16/5 overall satisfaction with teaching; 4.29/5 with the lab sections (ISOM undergraduate average: 3.9)</p>
  </div>
</div>
