...
<div class="timeline">
  <div class="timeline-item left">
    <h3>2024-08</h3>
    <p>Two papers are accepted by the 2024 CIST.</p>
  </div>
  <div class="timeline-item right">
    <h3>2024-07</h3>
    <p>Two papers are conditionally accepted by the 2024 ICIS.</p>
  </div>
  <div class="timeline-item left">
    <h3>2024-07</h3>
    <p>I passed the PhD Qualification Exam and became a PhD candidate.</p>
  </div>
  <div class="timeline-item right">
    <h3>2024-06</h3>
    <p>One paper is accepted by MIS Quarterly Virtual Paper Development Workshop.</p>
  </div>
</div>
