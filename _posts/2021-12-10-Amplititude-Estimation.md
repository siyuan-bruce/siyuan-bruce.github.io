...
It has eigenvalues $e^{2 i \theta_{a}}, e^{-2 i \theta_{a}}$ with corresponding eigenvectors $\frac{1}{2}(1 i), \frac{1}{2}(1-i)$, noted $\left|\Psi_{+}\right\rangle$and $\left|\Psi_{-}\right\rangle$.
