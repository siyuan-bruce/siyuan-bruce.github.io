...
Last month, I was engrossed in preparing a report for the Hong Kong Monetary Authority. Our team conducted a hypothetical e-HKD experiment on the HKUST campus. The pilot program concluded on September 22, with the report due by September 28. Hence, our team needed to be well-prepared to analyze the data from the pilot.
